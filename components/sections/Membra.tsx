...
export function Membra() {
  return (
    <section id="membra" style={{ padding: "100px 0", background: "var(--cream-50)" }}>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 32px" }}>
        <div
          className="membra-grid"
          style={{
            display: "grid",
      ...
      <style>{`
        @media (max-width: 900px) {
          .membra-grid { grid-template-columns: 1fr !important; gap: 48px !important; }
        }
      `}</style>
    </section>
  );
